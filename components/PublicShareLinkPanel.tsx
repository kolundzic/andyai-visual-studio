import { PublicShareLinkPanelItems, PublicShareLinkPanelSummary } from "@/lib/public-share-links";

export function PublicShareLinkPanel() {
  return (
    <section className="mx-auto max-w-6xl px-6 py-12">
      <div className="rounded-3xl border border-neutral-200 bg-white p-8 shadow-sm">
        <p className="text-sm font-semibold uppercase tracking-[0.24em] text-neutral-500">{PublicShareLinkPanelSummary.version}</p>
        <h1 className="mt-3 text-4xl font-bold tracking-tight text-neutral-950">{PublicShareLinkPanelSummary.title}</h1>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          {PublicShareLinkPanelItems.map((item) => (
